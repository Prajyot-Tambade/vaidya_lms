...
const UnauthorizedPage = () => {
  return (
    <section className="h-screen flex flex-col gap-2 justify-center">
      <div className="w-15 h-15 mb-4 rounded-full bg-red-300 mx-auto flex items-center justify-center">
        <AlertIcon width={32} height={32} />
      </div>
      <h1 className="text-center text-red-400 text-5xl">Access Denied!</h1>
